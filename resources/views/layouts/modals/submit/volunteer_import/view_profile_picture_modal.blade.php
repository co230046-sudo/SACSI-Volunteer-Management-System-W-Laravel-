{{-- ============================================================
   ✅ PROFILE PICTURE MODAL — PATCHED
   ✅ Removes its own success modal (#ppSuccessModal)
   ✅ Uses Universal Feedback Modal (UFM) for success/error notices
   ✅ Keeps style + behavior unchanged for the main picture modal
============================================================ --}}
...
/* =====================================================
   ✅ UFM SAFE WRAPPER
===================================================== */
function ufmShow({ variant='info', title='Notice', subtitle='', html='', source='profile_picture' } = {}) {
...
/* =====================================================
   ✅ REPLACED: PHOTO SUCCESS MODAL API -> now uses UFM
===================================================== */
function openPPSuccessModal({ title="Changes saved", subtitle="Entry updated successfully.", html="" } = {}) {
  const t = String(title || '').toLowerCase();
  const variant = (t.includes('fail') || t.includes('error')) ? 'error' : 'success';
...
/* =====================================================
   AUTO OPEN: success OR errors (NOW USES UFM)
===================================================== */
